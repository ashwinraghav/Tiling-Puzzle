...
public class Tile
{
	...
	public Tile(Cell startCell, Cell endCell, int numDominos, Collection<Domino> dominoList, Domino[][] matrix)
	{
		...
		this.matrix = matrix;
		flippedTileMatrices = new ArrayList<Domino[][]>(8);
	}
	...
	public void addFlippedTileMatrix(Domino[][] flippedMatrix) 
	{
		flippedTileMatrices.add(flippedMatrix);
	}

	public ArrayList<Domino[][]> getFlippedTileMatrices() {
		return flippedTileMatrices;
	}
