...
public class Driver
{
	...
	static public void start(String fileName, boolean isFlip)
	{
...
//		Printing.printTopPointerList(topPointerList);
	...
	//	Printing.printGrid(header, colPointerList); 
		...
		ArrayList<ArrayList<DataObject>> columnsCovered = new ArrayList<ArrayList<DataObject>>(); 
		System.out.println("Number of solutions = " + (DancingLinksImpl.doExtraCover(0,dObj,0, header, game.getTileList().size(), game.getTileList().size(), columnsCovered, game.getBoard())));
	}		
}
