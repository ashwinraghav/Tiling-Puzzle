...
public class TileTurner 
{
	...
	public static ArrayList<ArrayList<Integer>> eliminateDuplicates
	(
			ArrayList<ArrayList<Integer>> columndIDMapping,
			ArrayList<ArrayList<Integer>> turnedColumndIDs) 
	{
		ArrayList<ArrayList<Integer>> noDuplicatesList = new ArrayList<ArrayList<Integer>>(turnedColumndIDs.size());
